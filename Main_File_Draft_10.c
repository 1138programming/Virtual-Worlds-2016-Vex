...
task main()
{
	...
	moveBaseArmClawAndWrist(-127, -127, -50, openclaw, 127, 1.1);
	...
	turnRightWithGyro(127, 140);
	moveBaseForTime(127, 127, 0.8);
	moveBaseArmClawAndWrist(-75, 77, 110, closeclaw, -80, 1.45);
	moveBaseForTime(127, 127, 2.9);
	...
	turnLeftWithGyro(127, -172);
	moveBaseForTime(127, 127, 1);
	moveBaseArmAndClaw(-127, -100, 127, closeclaw, 1.6);
	moveBaseForTime(-90, -127, 0.6);
	moveClawForTime(openclaw);


	moveBaseAndArm(127, 60, -127, 2);
	moveBaseForTime(127, 127, 1.75);
	moveBaseArmAndClaw(127, -127, 127, closeclaw, 0.9);
	moveBaseAndWrist(127, 127, -100, 1.2);
	moveBaseForTime(127, 127, 1.5);
	moveExtensionUpForDistance(127, 500);
	moveBaseArmClawAndWrist(-127, -110, -127, openclaw, 80, 2);
}
